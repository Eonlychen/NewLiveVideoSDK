...
typedef NS_ENUM(NSInteger, LIVEVC_FILTER_TYPE) {
    LIVEVC_FILTER_TYPE_NORMAL,// 正常
    LIVEVC_FILTER_TYPE_GRAY,// 黑白
    LIVEVC_FILTER_TYPE_INVERTCOLORS, //反色（类似X光）
    LIVEVC_FILTER_TYPE_SEPIA,//小清新
    LIVEVC_FILTER_TYPE_BEAUTY, // 美颜
    LIVEVC_FILTER_TYPE_ANTIQUE //屏幕黄屏（问题！）
};
