...
//    }
//}
- (void)setFilter:(LIVEVC_FILTER_TYPE)type {
    switch (type) {
        case LIVEVC_FILTER_TYPE_NORMAL:
            [_livesession setFilter:VCFilterNormal];
            break;
        case LIVEVC_FILTER_TYPE_GRAY:
            [_livesession setFilter:VCFilterGray];
            break;
        case LIVEVC_FILTER_TYPE_INVERTCOLORS:
            [_livesession setFilter:VCFilterInvertColors];
            break;
        case LIVEVC_FILTER_TYPE_SEPIA:
            [_livesession setFilter:VCFilterSepia];
            break;
         case LIVEVC_FILTER_TYPE_BEAUTY:
            [_livesession setFilter:VCFilterBeauty];
            break;
        case LIVEVC_FILTER_TYPE_ANTIQUE:
            [_livesession setFilter:VCFilterAntique];
            break;
        default:
            break;
    }
...
- (void)setVideoZoomFactor:(CGFloat)videoZoomFactor {
    _livesession.videoZoomFactor = videoZoomFactor;
}
