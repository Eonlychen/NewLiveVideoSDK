...
-(void) UIInit{
    ...
    _MicSlider.minimumValue = 1;
    _MicSlider.maximumValue = 5;
...
-(void) RtmpInit{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [[LiveVideoCoreSDK sharedinstance] LiveInit:RtmpUrl Preview:_AllBackGroudView VideSize:videosize BitRate:LIVE_BITRATE_800Kbps FrameRate:LIVE_FRAMERATE_25 highQuality:true];
...
-(void) OnFilterClicked:(id)sender{
    ...
    [_FilterMenu setSelectedBlock:^(NSUInteger tag, NSString *title) {
        ...
        NSUInteger index = tag - 10000;
        LIVEVC_FILTER_TYPE filterType = (LIVEVC_FILTER_TYPE)index;
        [[LiveVideoCoreSDK sharedinstance] setFilter:filterType];
    }];
